...
task main()
{
    ...
    memcpy(secondary, primary, sizeof(Controller);  //  FIXME: fix all this...
		...
		if ( !MechanismIsKicking() && ControllerButtonIsPressed(secondary, ControllerButtonR1) )
		{
		  StartTask(MechanismKickBaton);
		}

		if ( !MechanismConveyorIsRunning() && ControllerButtonIsPressed(secondary, ControllerButtonL1) )
		{
