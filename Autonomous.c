...
task GetDoublerBaton()
{
	...
	RobotTravelFromKeyPointToKeyPoint(d, c);	// go to the dispenser
...
{
	Node bridgeID = FTCFieldGetKeyPointOfBridgeForTeam(FTCTeamGetCurrent());	//	FIXME: get id of closest bridge!!!!!!!!!!!!
